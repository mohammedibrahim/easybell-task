...
namespace EasyBell\Shared\Infrastructure\Doctrine;
...
use EasyBell\Shared\Infrastructure\Doctrine\Dbal\DbalCustomTypesRegistrar;
...
final class DoctrineEntityManagerFactory
{
    ...
    public static function create(
        ...
        return new EntityManager(
            DriverManager::getConnection($parameters, $config),
            $config,
            $eventManager
        );
    }
